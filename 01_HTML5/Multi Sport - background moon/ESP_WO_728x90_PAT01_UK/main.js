...
function init() {
    ...
    devDynamicContent.BundesligaDynamicGameSpecific_300x250[0].f5_icon3 = "EVERY SECOND<br/>OF THE ACTION";

    devDynamicContent.BundesligaDynamicGameSpecific_300x250[0].f6_text1 = "EXCLUSIVELY ON EUROSPORT PLAYER";

    devDynamicContent.BundesligaDynamicGameSpecific_300x250[0].f7_text1 = "5 DAY";
...
function fadeOut(){
    ...
    TweenMax.to(['#f7_text1','#f7_text2'], 0.6, {x:70, ease: Quint.easeOut, delay:1 });
