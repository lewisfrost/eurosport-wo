...
function init() {
    ...
    devDynamicContent.BundesligaDynamicGameSpecific_300x250[0].f5_text1 = "EVERY SECOND";
    devDynamicContent.BundesligaDynamicGameSpecific_300x250[0].f5_text2 = "OF THE ACTION";
...
function fadeOut(){
    ...
    TweenMax.set(['#f7_text1','#f7_text2'], {x:0, delay:1.5 });
