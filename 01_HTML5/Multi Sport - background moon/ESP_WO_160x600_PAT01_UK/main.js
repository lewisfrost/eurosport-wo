...
function init() {
    ...
    devDynamicContent.BundesligaDynamicGameSpecific_300x250[0].f6_text1 = "EVERY<br>SECOND OF<br>THE ACTION";
...
function step3 (){
           ...
           //.to(lineFour, 0.8, {delay:1.1, autoAlpha:1, scaleX:1.0, transformOrigin:"left"}, {ease: Quint.easeInOut });
