...
var frameDelays = [0,3.0,3.0,3.0,4.0,2.5];
...
function step4 (){
           ...
           TweenMax.to(['#f7_text1'], 0.6, {x:-30, ease: Quint.easeOut, delay:1.4 });

           TweenMax.set(['#f7_text2'], {rotation:0.01,transformOrigin:"50% 50%"});
           TweenMax.set(['#f7_text2'], {autoAlpha:1 ,delay:0.5});
           TweenMax.to(['#f7_text2'], 0.6, {x:-30, ease: Quint.easeOut, delay:1.4 });
...
function step5 (){
          ...
          TweenMax.to(['#f7_text1','#f7_text2','#cta'], 0.01, {autoAlpha:0, ease: Quint.easeOut, delay:0 });

          TweenMax.fromTo(mountain_01, 0.60, {x:0, y:0}, {x:0, y:-50}, Quint.easeOut);
          TweenMax.fromTo(mountain_02, 0.40, {x:2, y:0}, {delay:0.3, x:2, y:-50}, Quint.easeOut);
          TweenMax.fromTo(mountain_03, 0.38, {x:0, y:0}, {delay:0.45, x:0, y:-67}, Quint.easeOut);
...
function fadeOut(){
    ...
    TweenMax.to(mountain_03, 0.95, {delay:0, x:0, y:67}, Quint.easeIn);
