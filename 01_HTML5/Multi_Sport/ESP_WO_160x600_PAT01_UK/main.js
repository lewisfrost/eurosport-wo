...
function init() {
    ...
    devDynamicContent.BundesligaDynamicGameSpecific_300x250[0].f6_text1 = "EVERY<br>SECOND OF<br>PYEONGCHANG<br/>2018";

    devDynamicContent.BundesligaDynamicGameSpecific_300x250[0].f7_text1 = "EXCLUSIVELY<br>ON EUROSPORT<br>PLAYER";
...
function step1 (){
           ...
           TweenMax.fromTo(mountain_01, 1.20, {x:0, y:0}, {x:0, y:-289}, Quint.easeOut);
           TweenMax.fromTo(mountain_02, 0.80, {x:2, y:0}, {delay:0.3, x:2, y:-289}, Quint.easeOut);
...
function step3 (){
           ...
           TweenMax.to(mountain_01, 3.30, {x:0, y:289}, Quint.easeIn);
           TweenMax.to(mountain_02, 2.25, {delay:0, x:2, y:289}, Quint.easeIn);
...
function step7 (){
           ...
           TweenMax.to(['#f6_text1'], 0.7, {scale:1, ease: Bounce.easeOut, delay:0.3 });
