...
function init() {
    ...
    devDynamicContent.BundesligaDynamicGameSpecific_300x250[0].f6_text1 = "EVERY SECOND OF<br/>PYEONGCHANG 2018";

    devDynamicContent.BundesligaDynamicGameSpecific_300x250[0].f7_text1 = "EXCLUSIVELY ON<br/>EUROSPORT PLAYER";

    devDynamicContent.BundesligaDynamicGameSpecific_300x250[0].f8_text1 = "30 DAY";
    ...
    document.getElementById('f8_text1').innerHTML = dynamicContent.BundesligaDynamicGameSpecific_300x250[0].f8_text1
    document.getElementById('f8_text2').innerHTML = dynamicContent.BundesligaDynamicGameSpecific_300x250[0].f8_text2
...
function step1 (){
           ...
           TweenMax.fromTo(mountain_01, 1.20, {x:0, y:0}, {x:0, y:-155}, Quint.easeOut);
           TweenMax.fromTo(mountain_02, 0.80, {x:2, y:0}, {delay:0.3, x:2, y:-138}, Quint.easeOut);
           TweenMax.fromTo(mountain_03, 0.75, {x:0, y:0}, {delay:0.45, x:0, y:-161}, Quint.easeOut);
...
function step2 (){
           ...
           TweenMax.set('#f1_text1', {autoAlpha:1, scale:0.001});
           TweenMax.set('#f1_text2', {autoAlpha:1});

           TweenMax.to('#f1_text1', 0.8, {scale:1, ease: Bounce.easeOut, delay:0.01 });
           TweenMax.fromTo('#f1_text2', 0.6, {scale: 0.001}, {delay:0.40, scale:1.0}, {ease: Quint.easeOut });
}
...
function step3 (){
           ...
           TweenMax.to(mountain_01, 3.30, {x:0, y:155}, Quint.easeIn);
           TweenMax.to(mountain_02, 2.25, {delay:0, x:2, y:138}, Quint.easeIn);
           TweenMax.to(mountain_03, 1.95, {delay:0, x:0, y:161}, Quint.easeIn);
...
function step7 (){
           ...
           TweenMax.to(['#f5_icon3'], 0.6, {scale:0.01, autoAlpha:0, ease: Quint.easeOut, delay:0 });
           ...
           TweenMax.set(['#f6_text1'], {rotation:0.01,transformOrigin:"50% 50%"});
           TweenMax.set(['#f6_text1'], {autoAlpha:1, scale:0.001});
           TweenMax.to(['#f6_text1'], 0.8, {scale:1, ease: Bounce.easeOut, delay:0.3 });

}

function step8 (){

           TweenMax.to(['#f6_text1'], 0.6, {scale:0.001, autoAlpha:0, ease: Quint.easeOut, delay:0 });

           TweenMax.set(['#f7_text1'], {rotation:0.01,transformOrigin:"50% 50%"});
           TweenMax.set(['#f7_text1'], {autoAlpha:1 , delay:0.5});
           TweenMax.to(['#f7_text1'], 0.8, {y:-30, ease: Quint.easeOut, delay:0.5 });
...
function step9 (){
           ...
           TweenMax.to(['#f8_text1'], 0.6, {y:-30, ease: Quint.easeOut, delay:1.2 });

           TweenMax.set(['#f8_text2'], {rotation:0.01,transformOrigin:"50% 50%"});
           TweenMax.set(['#f8_text2'], {autoAlpha:1 ,delay:0.5});
           TweenMax.to(['#f8_text2'], 0.6, {y:-30, ease: Quint.easeOut, delay:1.1 });
...
function fadeOut(){
    ...
    TweenMax.to(['#f8_text1','#f8_text2','#cta'], 0.6, {autoAlpha:0, ease: Quint.easeOut, delay:0 });
    TweenMax.to(['#f8_text1'], 0.6, {y:30, ease: Quint.easeOut, delay:1 });
    TweenMax.to(['#f8_text2'], 0.6, {y:30, ease: Quint.easeOut, delay:1 });

    TweenMax.to(mountain_01, 2.30, {x:0, y:155}, Quint.easeIn);
    TweenMax.to(mountain_02, 1.25, {delay:0, x:2, y:138}, Quint.easeIn);
    TweenMax.to(mountain_03, 0.95, {delay:0, x:0, y:161}, Quint.easeIn);
