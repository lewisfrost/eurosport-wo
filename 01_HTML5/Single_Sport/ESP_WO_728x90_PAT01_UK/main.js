...
function step8 (){
           ...
           TweenMax.to(['#f7_text1'], 0.6, {x:-67, ease: Quint.easeOut, delay:1.2 });

           TweenMax.set(['#f7_text2'], {rotation:0.01,transformOrigin:"50% 50%"});
           TweenMax.set(['#f7_text2'], {autoAlpha:1 ,delay:0.5});
           TweenMax.to(['#f7_text2'], 0.6, {x:-67, ease: Quint.easeOut, delay:1.1 });
...
function fadeOut(){
    ...
    TweenMax.to(['#f7_text1'], 0.6, {x:67, ease: Quint.easeOut, delay:1 });
    TweenMax.to(['#f7_text2'], 0.6, {x:67, ease: Quint.easeOut, delay:1 });
