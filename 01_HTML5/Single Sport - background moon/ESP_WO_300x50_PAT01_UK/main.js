...
var frameDelays = [0,1.3,3.0,3.0,2.6];
...
function init() {
    ...
    devDynamicContent.BundesligaDynamicGameSpecific_300x250[0].f5_text1 = "ICE HOCKEY";
    devDynamicContent.BundesligaDynamicGameSpecific_300x250[0].f5_text2 = "FROM PYEONGCHANG 2018";
...
function step4 (){
           ...
           TweenMax.to(['#f6_text1'], 0.8, {y:-50, ease: Quint.easeOut, delay:0.5 });

           TweenMax.set(['#f6_text2'], {rotation:0.01,transformOrigin:"50% 50%"});
           TweenMax.set(['#f6_text2'], {autoAlpha:1 ,delay:1.3});
           TweenMax.to(['#f6_text2'], 0.8, {y:-50, ease: Quint.easeOut, delay:1.3 });
...
function step5 (){
           ...
           TweenMax.to(['#f6_text1','#f6_text2'], 0.01, {y:50, ease: Quint.easeOut, delay:0.6 });
...
function fadeOut(){
    ...
    //Fade Out Tween Code !!!!!!!
    TweenMax.to(['#f7_text1','#f7_text2','#cta',moon], 0.60, {autoAlpha:0, ease: Quint.easeOut, delay:0 });
