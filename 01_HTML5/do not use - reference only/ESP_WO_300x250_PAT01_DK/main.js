...
function init() {
    ...
    devDynamicContent.BundesligaDynamicGameSpecific_300x250[0].f5_text1 = "HVERT SEKUND AF";
    devDynamicContent.BundesligaDynamicGameSpecific_300x250[0].f5_text2 = "ICE HOCKEY";

    devDynamicContent.BundesligaDynamicGameSpecific_300x250[0].f6_text1 = "KUN PÅ";
    ...
    devDynamicContent.BundesligaDynamicGameSpecific_300x250[0].cta = "TILMELDING";
