...
function init() {
    ...
    devDynamicContent.BundesligaDynamicGameSpecific_300x250[0].f7_text1 = "EXCLUSIVELY ON EUROSPORT PLAYER";
...
function step1 (){
           ...
           TweenMax.fromTo(mountain_01, 1.20, {x:0, y:0}, {x:0, y:-288}, Quint.easeOut);
           TweenMax.fromTo(mountain_02, 0.80, {x:2, y:0}, {delay:0.3, x:2, y:-288}, Quint.easeOut);
           TweenMax.fromTo(mountain_03, 0.75, {x:0, y:0}, {delay:0.45, x:0, y:-332}, Quint.easeOut);
...
function step3 (){
           ...
           TweenMax.to(mountain_01, 3.30, {x:0, y:288}, Quint.easeIn);
           TweenMax.to(mountain_02, 2.25, {delay:0, x:2, y:288}, Quint.easeIn);
           TweenMax.to(mountain_03, 1.95, {delay:0, x:0, y:334}, Quint.easeIn);
...
function step8(){
           ...
           TweenMax.to(['#f6_text1'], 0.6, {scale:0.01, autoAlpha:0, ease: Quint.easeOut, delay:0 });
...
function step9 (){
           ...
           TweenMax.to(['#f8_text2'], 0.6, {y:-35, ease: Quint.easeOut, delay:1.1 });
...
function fadeOut(){
    ...
    TweenMax.to(['#f8_text1','#f8_text2'], 0.6, {y:35, ease: Quint.easeOut, delay:1.0 });

    TweenMax.to(mountain_01, 2.30, {x:0, y:288}, Quint.easeIn);
    TweenMax.to(mountain_02, 1.25, {delay:0, x:2, y:288}, Quint.easeIn);
    TweenMax.to(mountain_03, 0.95, {delay:0, x:0, y:320}, Quint.easeIn);
