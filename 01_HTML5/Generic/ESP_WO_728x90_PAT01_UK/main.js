...
var frameDelays = [0,1.0,2.1,2.4,3.2,2.1,2.6];
...
function init() {
    ...
    devDynamicContent.BundesligaDynamicGameSpecific_300x250[0].f5_icon3 = "EVERY SECOND OF<br/>PYEONGCHANG 2018";
...
function step1 (){
           ...
           TweenMax.fromTo(mountain_01, 0.60, {x:0, y:0}, {x:0, y:-75}, Quint.easeOut);
           TweenMax.fromTo(mountain_02, 0.40, {x:2, y:0}, {delay:0.3, x:2, y:-76}, Quint.easeOut);
           TweenMax.fromTo(mountain_03, 0.38, {x:0, y:0}, {delay:0.45, x:0, y:-90}, Quint.easeOut);
...
function step3 (){
           ...
           TweenMax.to(mountain_01, 1.65, {x:0, y:75}, Quint.easeIn);
           TweenMax.to(mountain_02, 1.13, {delay:0, x:2, y:76}, Quint.easeIn);
           TweenMax.to(mountain_03, 1.00, {delay:0, x:0, y:90}, Quint.easeIn);
...
function step4 (){
           ...
           TweenMax.to(['#f4_icon1'], 0.7, {scale:1, ease: Bounce.easeOut, delay:0.6 });
           TweenMax.to(['#f4_icon2'], 0.7, {scale:1, ease: Bounce.easeOut, delay:0.3 });
           TweenMax.to(['#f4_icon3'], 0.7, {scale:1, ease: Bounce.easeOut, delay:0.9 });

}

function step5 (){

           TweenMax.to(['#f4_icon1','#f4_icon2','#f4_icon3'], 0.6, {scale:0.01, autoAlpha:0, ease: Quint.easeOut, delay:0 });
...
function step6 (){
           ...
           TweenMax.to(mountain_01, 1.65, {x:0, y:75}, Quint.easeIn);
           TweenMax.to(mountain_02, 1.12, {delay:0, x:2, y:76}, Quint.easeIn);
           TweenMax.to(mountain_03, 1.00, {delay:0, x:0, y:90}, Quint.easeIn);
...
function step7 (){
           ...
           TweenMax.to(['#f7_text1'], 0.6, {x:-70, ease: Quint.easeOut, delay:1.1 });

           TweenMax.set(['#f7_text2'], {rotation:0.01,transformOrigin:"50% 50%"});
           TweenMax.set(['#f7_text2'], {autoAlpha:1 ,delay:0.5});
           TweenMax.to(['#f7_text2'], 0.6, {x:-70, ease: Quint.easeOut, delay:1.1 });
...
function fadeOut(){
    ...
    TweenMax.to(['#f7_text1'], 0.6, {x:70, ease: Quint.easeOut, delay:1 });
    TweenMax.to(['#f7_text2'], 0.6, {x:70, ease: Quint.easeOut, delay:1 });

    TweenMax.to(mountain_01, 2.30, {x:0, y:75}, Quint.easeIn);
    TweenMax.to(mountain_02, 1.25, {delay:0, x:2, y:76}, Quint.easeIn);
    TweenMax.to(mountain_03, 0.95, {delay:0, x:0, y:90}, Quint.easeIn);
