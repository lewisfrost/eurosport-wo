...
function init() {
    ...
    devDynamicContent.BundesligaDynamicGameSpecific_300x250[0].f3_text1 = "IJSHOCKEY";

    devDynamicContent.BundesligaDynamicGameSpecific_300x250[0].f5_text1 = "ELKE SECONDE VAN HET";
    devDynamicContent.BundesligaDynamicGameSpecific_300x250[0].f5_text2 = "IJSHOCKEYEN";

    devDynamicContent.BundesligaDynamicGameSpecific_300x250[0].f6_text1 = "EXCLUSIEF OP";
    devDynamicContent.BundesligaDynamicGameSpecific_300x250[0].f6_text2 = "EUROSPORT PLAYER";

    devDynamicContent.BundesligaDynamicGameSpecific_300x250[0].f7_text1 = "IJSHOCKEY PASS";
    devDynamicContent.BundesligaDynamicGameSpecific_300x250[0].f7_text2 = "€9.99";
    devDynamicContent.BundesligaDynamicGameSpecific_300x250[0].cta = "NEEM EEN ABONNEMENT";
  //  devDynamicContent.BundesligaDynamicGameSpecific_300x250[0].cta = "SIGN IN";
